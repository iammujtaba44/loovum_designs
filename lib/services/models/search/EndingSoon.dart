...
EndingSoonModel endingSoonModelFromJson(String str) =>
    EndingSoonModel.fromJson(json.decode(str));

String endingSoonModelToJson(EndingSoonModel data) =>
    json.encode(data.toJson());

class EndingSoonModel {
  EndingSoonModel({
    this.currentPage,
    this.data,
    this.firstPageUrl,
  ...
  factory EndingSoonModel.fromJson(Map<String, dynamic> json) =>
      EndingSoonModel(
        currentPage: json["current_page"],
        data: List<EndingSoonData>.from(
            json["data"].map((x) => EndingSoonData.fromJson(x))),
...
class EndingSoonData {
  ...
  factory EndingSoonData.fromJson(Map<String, dynamic> json) => EndingSoonData(
        id: json["id"],
