...
SiteRequiredDataModel siteRequiredDataModelFromJson(String str) =>
    SiteRequiredDataModel.fromJson(json.decode(str));

String siteRequiredDataModelToJson(SiteRequiredDataModel data) =>
    json.encode(data.toJson());

class SiteRequiredDataModel {
  SiteRequiredDataModel({
    this.setting,
    this.offer,
    this.categories,
    this.menus,
  ...
  factory SiteRequiredDataModel.fromJson(Map<String, dynamic> json) =>
      SiteRequiredDataModel(
